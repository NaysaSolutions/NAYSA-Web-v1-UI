...
//   // show loading immediately on fresh open / pasted URL
...
//       setRouteRows(Array.isArray(rData) ? rData : []);
//       sessionStorage.setItem("menuItems", JSON.stringify(Array.isArray(mData) ? mData : []));
//       sessionStorage.setItem("routeRows", JSON.stringify(Array.isArray(rData) ? rData : []));
//       menuFetchedRef.current = user.USER_CODE;
//     } catch (e) {
//       console.error("Metadata Fetch Error:", e);
//     } finally {
