  ...
  return (
    <div className="relative w-full">
      <style>{`
        ...
        .field-renderer-time-input {
          position: relative;
          padding-right: 2rem !important;
        }

        .field-renderer-time-input::-webkit-calendar-picker-indicator {
          position: absolute;
          right: 0.5rem;
          top: 50%;
          transform: translateY(-50%);
        ...
        .dark .field-renderer-time-input::-webkit-calendar-picker-indicator {
          filter: invert(1) brightness(1.6);
        }

        .field-renderer-time-input::-webkit-datetime-edit {
          padding-right: 1.25rem;
        }
      `}</style>
