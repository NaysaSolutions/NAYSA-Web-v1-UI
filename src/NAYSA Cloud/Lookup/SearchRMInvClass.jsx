...
const SearchRMInvClass = ({
  isOpen,
  onClose,
  title = "Search RM Classification Codes",
  ...
  const {
    ...
    queryKey: ["lookupRMInvClass"],
    queryFn: async () => {
      const res = await apiClient.get("/rmClass");
...
export default SearchRMInvClass;