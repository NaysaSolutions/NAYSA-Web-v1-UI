// src/NAYSA Cloud/Lookup/SearchVETypeRef.jsx
          ...
          {isLoading ? (
            ...
            <table className="min-w-full table-fixed">
              <thead className="sticky top-0 z-10 bg-slate-200">
                <tr>
                  {[
                    { key: "code", label: "Type Code", width: "w-[150px]" },
...
export default SearchVETypeRef;
