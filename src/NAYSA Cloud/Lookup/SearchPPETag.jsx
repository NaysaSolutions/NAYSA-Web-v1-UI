...
//                   {isEditMode ? "Property Tag Designer" : (isMultipleTags ? "Property Tags Preview" : "Property Tag Preview")}
//                 </h3>
...
//         {(isInitialPreviewLoading || isLayoutBusy || isCapturingPrint) && (
//           <div className="absolute inset-x-0 bottom-0 top-[78px] z-[60] flex items-center justify-center bg-white/60 backdrop-blur-[1px]">
//             <LoadingSpinner />
//           </div>
//         )}
...
//             <div ref={previewViewportRef} className="relative min-h-0 flex-1 overflow-auto rounded-2xl border border-slate-200 bg-slate-100/80 p-4 shadow-inner">
...
//           <div className={`min-h-0 overflow-auto rounded-2xl border border-slate-200 bg-white p-4 shadow-sm ${isCapturingPrint || isQzBusy ? "pointer-events-none opacity-60" : ""}`}>
