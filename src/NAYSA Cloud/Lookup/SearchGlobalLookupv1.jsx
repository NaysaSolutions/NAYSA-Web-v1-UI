...
/**
 * GlobalLookupModalv1 - FINAL++ (Requested Add-ons)
 *
 * ✅ Header ALWAYS frozen (separate header section)
 * ✅ Filter row frozen too
 * ✅ Vertical scrollbar ALWAYS visible
 * ✅ Horizontal scrollbar ALWAYS visible at bottom (dedicated bar)
 * ✅ Auto column width
 * ✅ Reorder columns (drag header)
 * ✅ Resize columns (drag right edge)
 *
 * NEW:
 * ✅ Persist column order + widths (localStorage by title OR endpoint signature)
 * ✅ Clear Filters button
 * ✅ Selected count + Clear Selection
 * ✅ Keyboard nav:
 *    - ↑↓ : move highlight row (within current page)
 *    - Enter : toggle select highlighted row
 *    - Esc : close (onCancel)
 * ✅ handleGetSelected returns in SELECTION ORDER (1st selected = 1st in payload)
 */
                          ...
                          paginatedData.map((row, idx) => {
                            ...
                            return (
                              <tr
                                ...
                                onDoubleClick={() => toggleSelect(row)}
                              >
                                <td
