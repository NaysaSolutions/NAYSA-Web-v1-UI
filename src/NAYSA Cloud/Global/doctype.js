...
export const docTypeNames = {
    ...
    DRC: "Delivery Receipt Consignment Transaction",
    ...
    VEAJ: "Vehicle Inventory Adjustment Transaction",
    VESR: "Vehicle Sales Return Transaction",
    ...
    VERTV: "Vehicle Return to Vendor Transaction",
