...
// import { faFolderOpen, faMagnifyingGlass, faPenToSquare, faPlus, faSave, faTag, faTrashAlt } from "@fortawesome/free-solid-svg-icons";
...
//   { key: "rcCode", label: "Dept", width: 118, align: "text-center" },
...
//             <div ref={itemDetailsRef} className="grid grid-cols-1 gap-3 p-3 lg:grid-cols-[1.22fr_2.3fr_1.15fr]">
...
//                       Review the selected asset before applying changes.
//                     </p>
//                   </div>
//                   <button
//                     type="button"
//                     className={`inline-flex shrink-0 items-center justify-center gap-2 rounded-lg px-3 py-2 text-xs font-semibold text-white shadow-sm transition-all duration-200 ${
//                       canEditSupplementDetails
...
//                     <div className="text-[11px] font-bold uppercase text-slate-500">Item Code</div>
//                     <div className="mt-1 break-words text-sm font-extrabold leading-5 text-slate-950">
//                       {selectedRow.itemCode || "-"}
//                     </div>
//                   </div>

//                   <div className="rounded-lg border border-slate-200 bg-white px-3 py-2">
//                     <div className="text-[11px] font-bold uppercase text-slate-500">Description</div>
//                     <div className="mt-1 max-h-24 overflow-auto break-words text-sm font-semibold leading-5 text-slate-950">
...
//                         <div className="mt-1 min-h-10 break-words text-[13px] font-semibold leading-5 text-slate-950">
//                           {value || "-"}
//                         </div>
//                       </div>
//                     ))}
...
//                       <div className="mt-1 text-sm font-bold text-slate-900">{selectedRow.unit || "-"}</div>
//                     </div>
//                     <div className="rounded-lg bg-slate-50 px-3 py-2 text-right">
//                       <div className="text-[11px] font-semibold text-slate-500">EUL</div>
//                       <div className="mt-1 text-sm font-bold text-slate-900">{selectedRow.eul || "0"}</div>
//                     </div>
//                   </div>
//                 </div>
//               </div>
...
import { useLocation } from "react-router-dom";
import { FontAwesomeIcon } from "@fortawesome/react-fontawesome";
import { faFolderOpen, faMagnifyingGlass, faPenToSquare, faPlus, faSave, faTag, faTags, faTrashAlt } from "@fortawesome/free-solid-svg-icons";
            ...
            <div ref={itemDetailsRef} className="grid grid-cols-1 gap-3 p-3 lg:grid-cols-[1.22fr_2.3fr_1.15fr]">
              ...
              <div className="rounded-md border border-slate-200 bg-white p-3">
                <div className="mb-2 flex flex-wrap items-center justify-between gap-2">
                  ...
                  <button
                    type="button"
                    className="flex items-center gap-2 rounded-md border border-blue-200 bg-blue-50 px-3 py-1.5 text-[11px] font-semibold text-blue-700 hover:bg-blue-100 disabled:cursor-not-allowed disabled:border-slate-200 disabled:bg-slate-50 disabled:text-slate-400"
