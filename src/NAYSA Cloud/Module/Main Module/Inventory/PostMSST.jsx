...
const PostMSST = ({ isOpen, onClose, userCode }) => {
  ...
  const handlePost = async (selectedData, userPw) => {
    await useHandlePostTran(selectedData, userPw, "MSST", userCode, setLoading, onClose);
  };
  ...
  <>
    ...
    {modalReady && (
      ...
      colConfigData={colConfigData}
        title="Finalize MS Stock Transfer"
