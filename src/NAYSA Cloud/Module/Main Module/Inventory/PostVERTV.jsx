  ...
  useEffect(() => {
    ...
    (async () => {
      try {
        ...
        if (!rows.length) {
          if (!alertFired.current) useSwalValidationAlert({ icon: "info", title: "No Transactions to Post", message: "There are no Vehicle Returns to Vendor available for posting." });
