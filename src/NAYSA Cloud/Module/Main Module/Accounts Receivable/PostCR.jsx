...
const PostCR = ({ isOpen, onClose,userCode }) => {
...
const handleViewDocument = (row) => {
 ...
 const SVI_VIEW_URL = "/page/CR";
const url =
  `${window.location.origin}${SVI_VIEW_URL}` +
  `?crNo=${encodeURIComponent(docNo)}` +
...
return (
  <>
    ...
    {modalReady && (
      ...
      title="Finalize Collection Receipt" 
