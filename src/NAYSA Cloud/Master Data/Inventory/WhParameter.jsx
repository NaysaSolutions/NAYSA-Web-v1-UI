...
const WhParameter = forwardRef(({ isMobile, onMobileActionOpen }, ref) => {
  ...
  return (
    <div className="flex-1 w-full min-h-[500px] flex flex-col items-center justify-center bg-white dark:bg-gray-800 rounded-xl border border-gray-100 dark:border-gray-700 shadow-lg p-8 text-center mt-2">
      ...
      <div className="relative w-24 h-24 mb-6 flex items-center justify-center">
        ...
        >
          ...
          <circle
            ...
            cy="48"
            r="46"
            className="fill-orange-50 dark:fill-gray-700 stroke-orange-100 dark:stroke-gray-600"
            strokeWidth="1"
          />
          ...
          >
            <path
              ...
              className="fill-orange-100 dark:fill-gray-600 stroke-orange-400 dark:stroke-orange-400"
              strokeWidth="0.8"
            />
            <circle
              cx="48"
              cy="50"
              r="6"
              className="fill-white dark:fill-gray-800 stroke-orange-400 dark:stroke-orange-400"
              strokeWidth="1.5"
            />
          </g>
          ...
          >
            <path
              ...
              className="fill-yellow-50 dark:fill-gray-600 stroke-yellow-400 dark:stroke-yellow-400"
              strokeWidth="0.8"
            />
            <circle
              cx="66"
              cy="34"
              r="4"
              className="fill-white dark:fill-gray-800 stroke-yellow-400 dark:stroke-yellow-400"
              strokeWidth="1.5"
            />
          </g>
        </svg>
      ...
      {/* Badge */}
      <span className="inline-block mb-3 px-3 py-0.5 rounded-md text-xs font-medium bg-orange-50 dark:bg-orange-900/30 text-orange-600 dark:text-orange-400 border border-orange-200 dark:border-orange-700 tracking-wide uppercase">
        🚧 Under Construction
      </span>
      ...
      <div className="w-full max-w-xs mb-6">
        <div className="flex justify-between items-center mb-1.5">
          ...
          <span className="text-xs font-medium text-orange-500 dark:text-orange-400">45%</span>
        </div>
      ...
      <div className="grid grid-cols-3 gap-2 w-full max-w-xs mb-6">
        ...
        {/* Step 2 — In Progress */}
        <div className="flex flex-col items-center gap-1.5 bg-orange-50 dark:bg-orange-900/20 border border-orange-200 dark:border-orange-700 rounded-lg py-3 px-2">
          ...
          <span className="text-xs text-orange-500 dark:text-orange-400 leading-tight text-center font-medium">Building</span>
        </div>
